...
const FishingWaterScreen = ({
  ...
  const [fishingCardInfo, setFishingCardInfo] =
    useState<FishingCardInfo | null>(null);
  ...
  const relevantFish = fiskarter.filter(
    (fish) => fish.lakes && fish.lakes.includes(title!)
  );
        ...
        <ScrollView style={styles.card}>
          ...
          {loading ? (
            ...
            <View style={styles.scrollView}>
              {lakeImage && (
                <Image source={{ uri: lakeImage }} style={styles.image} />
              )}
                ...
                <View style={styles.infoCard}>
                  ...
                  {fishingCardInfo.fishingService && (
                    <>
                      ...
                      <Text>
                        {fishingCardInfo.fishingService.depthMap.info}
                      </Text>
                      <Text>
                        Pris: {fishingCardInfo.fishingService.depthMap.price}
                      </Text>
                    </>
                  )}
